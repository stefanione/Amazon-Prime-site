...
public class SortForFilterDecreasingIncreasing implements SortingForFilterDecreasingIncreasing,
        InterfaceForfilterDecreasingIncreasing {

    /** this method sorts the array correspondly */
    @Override
    public void sortingForFilterDecreasingIncreasing(
    ...
    @Override
    public void sortingForFilterDecreasingIncreasing() {
        System.out.println("sortedDecreasingIncreasing");
    }
}
